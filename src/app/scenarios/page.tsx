...
export default function HomePage() {
  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      {/* Jeux Rapides */}
      <section className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8">Entraînement rapide</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {games.slice(0, 2).map((game, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative overflow-hidden rounded-2xl border border-gray-800 hover:border-blue-500/50 transition-all duration-300 cursor-pointer"
              onClick={() => router.push(`/games/${game.id}`)}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 to-purple-900/10 group-hover:opacity-100 opacity-50 transition-opacity" />
              ...
              <div className="relative p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm px-2 py-1 bg-gray-800 rounded-full">
                        {game.duration} min
                      </span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-400">
                    Score moyen: <span className="text-emerald-400">{game.avgScore}%</span>
                  </span>
                  <button className="px-4 py-2 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
                    Jouer
                  </button>
                </div>
              </div>
      ...
      >
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 p-12">
